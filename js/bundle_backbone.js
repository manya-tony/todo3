...
var ListView = Backbone.View.extend({
  ...
  searchItem: function(key){
    this.collection.each(function(model, i){
      ...
      if(text && text.match(new RegExp('^' + key))){
...
var FormView = Backbone.View.extend({
  ...
  addTodo: function(e){
    ...
    if(!val) {
      this.model.set({hasError: true, errorMsg: '何も入力されていません'});
    } else {
      this.model.set({val: $('.js-get-val').val(), hasError: false});
